package com.verzeo.myintro_app;
...
import com.verzeo.myintro_app.portfolio.PortfolioFragment;
import com.verzeo.myintro_app.sidemenu.Callback;
import com.verzeo.myintro_app.sidemenu.MenuAdapter;
import com.verzeo.myintro_app.sidemenu.MenuItem;
import com.verzeo.myintro_app.sidemenu.MenuUtil;

import java.util.List;

import contacts.ContactsFragment;
import cv.CVFragment;
...
public class MainActivity extends AppCompatActivity implements Callback {
    ...
    public void onSideMenuItemClick(int i) {
        ...
        switch (menuItems.get(i).getCode()) {
            ...
            case MenuUtil.CONTACTS_FRAGMENT_CODE: setContactsFragment();
            break;
